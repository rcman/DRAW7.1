...
void helpscreen(void)
{
    ...
    cprintf("   ]       - Undocumented Load Old \r\n");
    cprintf("   Arrow Right - Move Object to right with trim \r\n");
    cprintf("   Arrow Left  - Move Object to left with trim \r\n");
    cprintf("   Arrow Down  - Move Object down with trim \r\n");
    cprintf("   Arrow Up    - Move Object up the object with trim \r\n");
